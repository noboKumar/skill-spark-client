...
const BecomeATeacher = () => {
  return (
    <div className="flex flex-col-reverse gap-5 lg:flex-row justify-between items-center px-5 md:px-20 py-10 border-2 border-gray-300 bg-base-200 rounded-4xl shadow-lg my-20">
